...
objects all categories. For categories $\mathcal C$ and
...
We will follow \cite{rebro} to construct such an example.
...
\begin{equation*}
  ...
  \end{tikzcd}
\end{equation*}
the map $P\to X$ factors through $A$ and hence there is a unique
map of spans $P\to A$. Thus we obtain canonical isomorphisms
...
\begin{definition}
  ...
  a functor $T:\mathcal C\to\mathcal C$ and natural transformations
...
have chosen the 2-cell to go the other way. This would have resulted
...
is referred to as lax. \cite{clarke2019}
...
\begin{proposition}
  ...
  \begin{proof}
    ...
    inclusion.
    Now consider a functor $F:\mathbb C\to\mathbb D$. We want
