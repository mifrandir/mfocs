...
$\textbf{Mon}(\mathcal C,I,\otimes)$ of monoid objects in
a monoidal category $(\mathcal C,I,\otimes)$.
...
\begin{proposition}
  ...
  \begin{proof}
    ...
    are identical for monoid objects in $(\Hom[\mathcal C,\mathcal
    C],\text{Id},\circ)$ and monads on $\mathcal C$, respectively.
  \end{proof}
\end{proposition}
