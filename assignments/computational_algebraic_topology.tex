...
\begin{lemma}
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      \right)
    \end{align*}
    Observing $C(\Sigma)=\left\lbrace{\sigma_\rho,\tau_\rho}\right\rbrace$ it is now straightforward to check that all terms cancel. By
...
\begin{align*}
  \restrict{\phi_d}{\alpha,\omega} := \sum_{\rho\in P(\Sigma),\sigma_\rho = \alpha} (-1)^{|\rho|}\partial_{\omega,\tau_\rho}\circ\partial_\rho
\end{align*}
otherwise.
...
\begin{lemma}
  ...
  \begin{proof}
    ...
    If $\alpha\not\in C(\Sigma)$ then
    \begin{align*}
      \restrict{(\partial^\Sigma\circ\phi_d)}{\alpha,\omega'}
      &= \sum_{\omega\in C(\Sigma)\cap K_d} \restrict{\partial^\Sigma}{\omega,\omega'}\circ \restrict{\phi_d}{\alpha,\omega}\\
      &=
    ...
    have the zero map. For $\alpha\in C(\Sigma)$, we must have
    $\restrict{\phi_d}{\alpha,\omega}=0$ whenever $\alpha\neq\omega$
    so
    \begin{align*}
      \restrict{(\partial^\Sigma\circ\phi_d)}{\alpha,\omega'}
      = \restrict{\partial^\Sigma}{\alpha,\omega'}
    ...
    \begin{align*}
      \restrict{(\phi_{d-1}\circ \partial)}{\alpha,\omega'}
      &= \sum_{\alpha'\in K_{d-1}} \restrict{\phi_{d-1}}{\alpha',\omega'}\circ \restrict{\partial}{\alpha,\alpha'}\\
      &=
      \partial_{\omega',\alpha}
      + \sum_{\alpha'\neq\omega'\in K_{d-1}}
...
\begin{align*}
  \restrict{\psi_d}{\omega,\alpha}:=\sum_{\rho\in P(\Sigma),\tau_\rho=\alpha} (-1)^{|\rho|}\partial_\rho \circ \partial_{\sigma_\rho,\omega}
\end{align*}
otherwise.
\begin{lemma}
  ...
  \begin{proof}
    ...
    \begin{align}\label{eq:psi_chain_case}
      \restrict{(\partial\circ\psi_d)}{\omega,\alpha'}
      = \sum_{\alpha\in K_d} \restrict{\partial}{\alpha,\alpha'} \circ \restrict{\psi_d}{\omega,\alpha}
    ...
    cases. If $\alpha'\in C(\Sigma)$ then
    \begin{align*}
      \restrict{(\psi_{d-1} \circ \partial^\Sigma)}{\omega,\alpha'}
      &= \sum_{\omega'\in C(\Sigma)\cap K_{d-1}}
      \restrict{\psi_{d-1}}{\omega',\alpha'}\circ\restrict{\partial^\Sigma}{\omega,\omega'} \\
      &= \partial_{\alpha',\omega}
      + \sum_{\alpha'\neq\omega'\in C(\Sigma)\cap K_{d-1}}
      \restrict{\psi_{d-1}}{\omega',\alpha'}\circ\restrict{\partial^\Sigma}{\omega,\omega'} \\
      &= \partial_{\alpha',\omega}.
    \end{align*}
    ...
    \begin{align*}
      \restrict{(\psi_{d-1} \circ \partial^\Sigma)}{\omega,\alpha'}
      = \sum_{\omega'\in C(\Sigma)\cap K_{d-1}}
      \restrict{\psi_{d-1}}{\omega',\alpha'}\circ\restrict{\partial^\Sigma}{\omega,\omega'} = 0.
    \end{align*}
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    a boundary component $\restrict{\partial^\Sigma}{\sigma,\tau}$
...
$H_k(K;\mathscr C^i)\hookrightarrow H_k(K;\mathscr C^{i+1})$ and
$H^\Sigma_k(K;\mathscr C^i)\hookrightarrow H^\Sigma_k(K;\mathscr C^{i+1})$
