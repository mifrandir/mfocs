...
\begin{equation*}
  % https://q.uiver.app/#q=WzAsNCxbMCwxLCJYIl0sWzAsMCwiR1xcdGltZXMgWCJdLFsyLDAsIkdcXHRpbWVzXFxtYXRoZnJhayBnXioiXSxbMiwxLCJcXG1hdGhmcmFrIGdeKiJdLFsxLDAsIlxccmhvIl0sWzIsMywiXFx0ZXh0e0FkfV4qIl0sWzEsMiwiXFx0ZXh0e2lkfVxcdGltZXNcXG11Il0sWzAsMywiXFxtdSJdXQ==
  \begin{tikzcd}
...
\begin{example}
  ...
  \begin{align*}
   ...
   \Omega^0_{\mathbb{R}}(C).
  \end{align*}
  \todo{verify that this is a moment map}
\end{example}
