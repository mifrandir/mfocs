...
there is a diffeomorphism $G\cdot x \cong G$. This means in particular that the calculation 
...
ensure orbits with closed tangent spaces. The one we choose is the following:
