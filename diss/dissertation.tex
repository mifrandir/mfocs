...
$H^0(C,\mathscr L)\otimes\mathscr O_C$ of rank
$\dim_{\mathbb C} H^0(C,\mathscr L)$.
...
$\projective{}{}(H^0(C,\mathscr L)^\vee)$. It turns out that this map
...
\begin{lemma}
  Higgs bundles on the compact Riemann surfaces are equivalent
  to Higgs sheaves on smooth algebraic curves.
  \begin{proof}
    \missingproof
  \end{proof}
\end{lemma}
...
\begin{example}
  ...
  \begin{align*}
    \hat q : \mathscr O^{\oplus n}_{Q(r,d)\times C} \to \mathscr U.
  \end{align*}
  ...
  \begin{align*}
    (f:T\to\mathcal Q(r,d))
    \mapsto
    \Gamma(C\times T,(\identity\times f)^*\Hom(\mathscr U,\mathscr U\otimes\mathscr K))
  \end{align*}
  is represented by a $\mathcal Q(r,d)$-scheme $\mathcal F(r,d)$.
  ...
  \begin{align*}
    \Gamma(C\times\Spec\mathbb C,(\identity\times f)^*\mathscr K_{C\times\mathcal Q(r,d)})
    \cong \Gamma(C,\mathscr K_C).
  \end{align*}
