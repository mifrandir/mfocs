...
\begin{example}
  ...
  \end{align*}
  is a Banach manifold. Now the infinitesimal action is 
  \begin{align*}
    \rho : \mathfrak u(1) &\to \Gamma^\infty (TU(E,h)) \\
    iy &\mapsto g \mapsto i y g
  \end{align*}
\end{example}

Unfortunately, we are not yet ready to apply this theorem to
