...
\begin{example}
  ...
  \begin{align*}
    T_g U(E,h)_\ell = W_{2,\ell}(C,\End(E,h)).
  \end{align*}
\end{example}
...
We will make see which of properties of our actions are necessary to
...
restrict our moduli spaces to avoid some special cases while in others
...
\begin{example}
  The Lie algebra of $U(E,h)_\ell$ is $W_{2,\ell}(C,\End(E,h))$.
\end{example}
...
\begin{example}
  ...
  \begin{align*}
    (g,\nabla) & \mapsto g\nabla g^{-1}.
  \end{align*}
  Note that, if we fix $\nabla_0\in\Omega^1(C,\End(E,h))$ and write
  $\nabla = \nabla_0 + $
...
\begin{example}
  ...
  \begin{align*}
    T_g G(E,h)_\ell = W_{2,\ell}(C,\End(E,h))/i\mathbb{R}.
  \end{align*}
\end{example}
...
\begin{example}\label{ex:nabla_hat_elliptic}
  ...
  \begin{equation*}
    ...
    \begin{tikzcd}
      0 & {\Omega^0_{\mathbb R}(\End(E,h))} & {\Omega^1_{\mathbb R}(\End(E,h))} & {\Omega^2_{\mathbb R}(\End(E,h))} & 0
