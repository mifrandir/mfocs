...
\begin{example}
  ...
  \begin{align*}
    \mathcal Q(r,d) := Quot(\mathscr O^{\oplus n}_C)^{r,d}
  \end{align*}
\end{example}

Some creativity is required to extend this procedure to Higgs
sheaves. What we are looking for is a scheme whose closed points
are pairs $(\mathscr E,\phi)$ where $\mathscr E\in\mathcal Q(r,d)$
